...
def countFingers(image, hand_landmarks, handNo=0):
    #get all lanmarks on the first hand visible
    ...
    for lm_index in tipIds:
            #get fingers tip and bottom y position value
            finger_tip_y=landmarks[lm_index].y
            finger_bottom_y=landmarks[lm_index-2].y
            #check if any finger is open or close
            if lm_index !=4:
                ...
                if finger_tip_y > finger_bottom_y:
                    fingers.append(0)
                    print("finger with id",lm_index,"it's closed")
    #print(fingers)
